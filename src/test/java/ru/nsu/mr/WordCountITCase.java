...
class WordCountITCase {
    ...
    public void testWordCounter(WordCounterConfig testConfig) throws IOException {
        ...
        List<Path> inputFiles = generatesInputFiles(inputFilesCount, testConfig.WORDS, eachWordPerFileCount);
    ...
    public static class WordCounterConfig {
        ...
        WordCounterConfig(int eachWordCount, int inputFilesCount, int mappersCount, int reducersCount) {
        ...
        public String toString() {
            return "M = " + mappersCount + ", R = " + reducersCount + ", files = " +
                inputFilesCount + ", each word per file = " + eachWordPerFileCount;
        }
    }

    static Stream<WordCounterConfig> wordCounterParameters() {
        return Stream.of(
            new WordCounterConfig(10, 10, 3, 4),
            new WordCounterConfig(5, 50, 2, 3)
        );
    }
